...
INSERT INTO `brand` VALUES ('Anna Sui','안나수이'),('Bvlgari','불가리'),('Byredo','바이레도'),('Calvin Klein','캘빈클라인'),('Chanel','샤넬'),('Diptyque','딥디크'),('Dolce&Gabbana','돌체엔가바나'),('Givenchy','지방시'),('Gucci','구찌'),('Hermes','에르메스'),('Jo Malone London','조말론'),('Lanvin','랑방'),('Le Labo','르라보');
